...
[![Tests](https://img.shields.io/badge/tests-5513%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.272` / `0.37.9.114` (2026-07-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (156 suites / 5513 tests / 0 fail; must ALL pass before push)
