...
[![Tests](https://img.shields.io/badge/tests-4770%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.192` / `0.37.9.71` (2026-06-28) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (135 suites / 4770 tests / 0 fail; must ALL pass before push)
