...
[![Tests](https://img.shields.io/badge/tests-4428%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.147` / `0.37.9.70` (2026-06-13) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (125 suites / 4428 tests / 0 fail; must ALL pass before push)
