...
[![Tests](https://img.shields.io/badge/tests-5524%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.273` / `0.37.9.115` (2026-07-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (157 suites / 5524 tests / 0 fail; must ALL pass before push)
