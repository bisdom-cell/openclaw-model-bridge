...
[![Tests](https://img.shields.io/badge/tests-4918%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.198` / `0.37.9.72` (2026-06-30) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (138 suites / 4918 tests / 0 fail; must ALL pass before push)
