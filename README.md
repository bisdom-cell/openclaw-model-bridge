...
[![Tests](https://img.shields.io/badge/tests-6277%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.331` / `0.37.9.160` (2026-08-28) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (188 suites / 6277 tests / 0 fail; must ALL pass before push)
