...
[![Tests](https://img.shields.io/badge/tests-6009%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.316` / `0.37.9.146` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (179 suites / 6009 tests / 0 fail; must ALL pass before push)
