...
[![Tests](https://img.shields.io/badge/tests-5955%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.311` / `0.37.9.143` (2026-08-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (177 suites / 5955 tests / 0 fail; must ALL pass before push)
