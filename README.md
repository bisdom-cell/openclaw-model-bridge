...
[![Tests](https://img.shields.io/badge/tests-6200%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.328` / `0.37.9.158` (2026-08-25) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (186 suites / 6200 tests / 0 fail; must ALL pass before push)
