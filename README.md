...
[![Tests](https://img.shields.io/badge/tests-4950%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.209` / `0.37.9.80` (2026-07-01) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (139 suites / 4950 tests / 0 fail; must ALL pass before push)
