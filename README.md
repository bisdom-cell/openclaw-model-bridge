...
[![Tests](https://img.shields.io/badge/tests-6614%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.361` / `0.37.9.180` (2026-09-25) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (200 suites / 6614 tests / 0 fail; must ALL pass before push)
