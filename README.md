...
[![Tests](https://img.shields.io/badge/tests-5094%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.228` / `0.37.9.92` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (143 suites / 5094 tests / 0 fail; must ALL pass before push)
