...
[![Tests](https://img.shields.io/badge/tests-4609%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.162` / `0.37.9.70` (2026-06-16) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (131 suites / 4609 tests / 0 fail; must ALL pass before push)
