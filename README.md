...
[![Tests](https://img.shields.io/badge/tests-5812%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.302` / `0.37.9.135` (2026-08-13) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (170 suites / 5812 tests / 0 fail; must ALL pass before push)
