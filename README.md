...
[![Tests](https://img.shields.io/badge/tests-3996%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.109` / `0.37.9.68` (2026-06-04) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
