...
[![Tests](https://img.shields.io/badge/tests-5457%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.251` / `0.37.9.101` (2026-07-06) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (154 suites / 5457 tests / 0 fail; must ALL pass before push)
