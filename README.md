...
[![Tests](https://img.shields.io/badge/tests-6081%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.322` / `0.37.9.152` (2026-08-19) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (181 suites / 6081 tests / 0 fail; must ALL pass before push)
