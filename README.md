...
[![Tests](https://img.shields.io/badge/tests-4945%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.205` / `0.37.9.78` (2026-06-30) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (138 suites / 4945 tests / 0 fail; must ALL pass before push)
