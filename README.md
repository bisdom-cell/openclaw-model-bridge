...
[![Tests](https://img.shields.io/badge/tests-5085%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.227` / `0.37.9.91` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (142 suites / 5085 tests / 0 fail; must ALL pass before push)
