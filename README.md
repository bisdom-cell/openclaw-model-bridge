...
[![Tests](https://img.shields.io/badge/tests-5772%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.300` / `0.37.9.134` (2026-08-12) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (168 suites / 5772 tests / 0 fail; must ALL pass before push)
