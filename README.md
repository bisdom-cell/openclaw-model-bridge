...
[![Tests](https://img.shields.io/badge/tests-6586%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.358` / `0.37.9.178` (2026-09-23) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (199 suites / 6586 tests / 0 fail; must ALL pass before push)
