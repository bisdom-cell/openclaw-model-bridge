...
[![Tests](https://img.shields.io/badge/tests-5664%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.290` / `0.37.9.127` (2026-08-08) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (163 suites / 5664 tests / 0 fail; must ALL pass before push)
