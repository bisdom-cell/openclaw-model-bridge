...
[![Tests](https://img.shields.io/badge/tests-4954%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.211` / `0.37.9.81` (2026-07-01) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (139 suites / 4954 tests / 0 fail; must ALL pass before push)
