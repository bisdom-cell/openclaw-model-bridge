...
[![Tests](https://img.shields.io/badge/tests-6358%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.336` / `0.37.9.162` (2026-09-01) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (191 suites / 6358 tests / 0 fail; must ALL pass before push)
