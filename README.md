...
[![Tests](https://img.shields.io/badge/tests-5875%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.305` / `0.37.9.138` (2026-08-14) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (172 suites / 5875 tests / 0 fail; must ALL pass before push)
