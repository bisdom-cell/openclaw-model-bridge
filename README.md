...
[![Tests](https://img.shields.io/badge/tests-4763%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.187` / `0.37.9.71` (2026-06-25) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (135 suites / 4763 tests / 0 fail; must ALL pass before push)
