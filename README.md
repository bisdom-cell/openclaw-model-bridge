...
[![Tests](https://img.shields.io/badge/tests-6524%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.354` / `0.37.9.175` (2026-09-22) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (196 suites / 6524 tests / 0 fail; must ALL pass before push)
