...
[![Tests](https://img.shields.io/badge/tests-5114%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.229` / `0.37.9.93` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (144 suites / 5114 tests / 0 fail; must ALL pass before push)
