...
[![Tests](https://img.shields.io/badge/tests-5618%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.284` / `0.37.9.123` (2026-07-31) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (161 suites / 5618 tests / 0 fail; must ALL pass before push)
