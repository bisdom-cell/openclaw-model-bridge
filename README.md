...
[![Tests](https://img.shields.io/badge/tests-4040%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.111` / `0.37.9.68` (2026-06-05) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
