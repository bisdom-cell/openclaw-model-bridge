...
[![Tests](https://img.shields.io/badge/tests-6436%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.349` / `0.37.9.173` (2026-09-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (195 suites / 6436 tests / 0 fail; must ALL pass before push)
