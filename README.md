...
[![Tests](https://img.shields.io/badge/tests-4676%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.174` / `0.37.9.71` (2026-06-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (133 suites / 4676 tests / 0 fail; must ALL pass before push)
