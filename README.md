...
[![Tests](https://img.shields.io/badge/tests-5741%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.294` / `0.37.9.131` (2026-08-10) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (166 suites / 5741 tests / 0 fail; must ALL pass before push)
