...
[![Tests](https://img.shields.io/badge/tests-5765%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.299` / `0.37.9.133` (2026-08-12) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (167 suites / 5765 tests / 0 fail; must ALL pass before push)
