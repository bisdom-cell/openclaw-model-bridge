...
[![Tests](https://img.shields.io/badge/tests-4743%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.183` / `0.37.9.71` (2026-06-22) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (134 suites / 4743 tests / 0 fail; must ALL pass before push)
