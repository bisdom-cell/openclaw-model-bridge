...
[![Tests](https://img.shields.io/badge/tests-5476%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.261` / `0.37.9.109` (2026-07-08) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (154 suites / 5476 tests / 0 fail; must ALL pass before push)
