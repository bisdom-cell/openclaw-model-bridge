...
[![Tests](https://img.shields.io/badge/tests-6109%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.323` / `0.37.9.153` (2026-08-20) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (182 suites / 6109 tests / 0 fail; must ALL pass before push)
