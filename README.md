...
[![Tests](https://img.shields.io/badge/tests-5135%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.230` / `0.37.9.94` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (144 suites / 5135 tests / 0 fail; must ALL pass before push)
