...
[![Tests](https://img.shields.io/badge/tests-6170%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.327` / `0.37.9.157` (2026-08-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (186 suites / 6170 tests / 0 fail; must ALL pass before push)
