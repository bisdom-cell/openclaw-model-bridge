...
[![Tests](https://img.shields.io/badge/tests-5511%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.271` / `0.37.9.113` (2026-07-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (156 suites / 5511 tests / 0 fail; must ALL pass before push)
