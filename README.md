...
[![Tests](https://img.shields.io/badge/tests-5546%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.281` / `0.37.9.121` (2026-07-26) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (158 suites / 5546 tests / 0 fail; must ALL pass before push)
