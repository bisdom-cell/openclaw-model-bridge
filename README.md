...
[![Tests](https://img.shields.io/badge/tests-4445%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.149` / `0.37.9.70` (2026-06-14) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (126 suites / 4445 tests / 0 fail; must ALL pass before push)
