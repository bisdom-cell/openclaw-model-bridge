...
[![Tests](https://img.shields.io/badge/tests-5439%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.241` / `0.37.9.100` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (153 suites / 5439 tests / 0 fail; must ALL pass before push)
