...
[![Tests](https://img.shields.io/badge/tests-5077%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.226` / `0.37.9.90` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (141 suites / 5077 tests / 0 fail; must ALL pass before push)
