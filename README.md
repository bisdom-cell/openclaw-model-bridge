...
[![Tests](https://img.shields.io/badge/tests-5490%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.270` / `0.37.9.112` (2026-07-21) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (155 suites / 5490 tests / 0 fail; must ALL pass before push)
