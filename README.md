...
[![Tests](https://img.shields.io/badge/tests-5231%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.238` / `0.37.9.98` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (148 suites / 5231 tests / 0 fail; must ALL pass before push)
