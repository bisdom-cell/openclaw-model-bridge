...
[![Tests](https://img.shields.io/badge/tests-4711%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.177` / `0.37.9.71` (2026-06-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (134 suites / 4711 tests / 0 fail; must ALL pass before push)
