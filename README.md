...
[![Tests](https://img.shields.io/badge/tests-6144%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.325` / `0.37.9.155` (2026-08-23) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (184 suites / 6144 tests / 0 fail; must ALL pass before push)
