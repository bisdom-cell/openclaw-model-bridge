...
[![Tests](https://img.shields.io/badge/tests-6010%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.317` / `0.37.9.147` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (179 suites / 6010 tests / 0 fail; must ALL pass before push)
