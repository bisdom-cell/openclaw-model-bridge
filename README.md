...
[![Tests](https://img.shields.io/badge/tests-5917%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.308` / `0.37.9.140` (2026-08-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (174 suites / 5917 tests / 0 fail; must ALL pass before push)
