...
[![Tests](https://img.shields.io/badge/tests-5020%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.221` / `0.37.9.86` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (140 suites / 5020 tests / 0 fail; must ALL pass before push)
