...
[![Tests](https://img.shields.io/badge/tests-5940%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.310` / `0.37.9.142` (2026-08-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (176 suites / 5940 tests / 0 fail; must ALL pass before push)
