...
[![Tests](https://img.shields.io/badge/tests-6552%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.355` / `0.37.9.176` (2026-09-22) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (197 suites / 6552 tests / 0 fail; must ALL pass before push)
