...
[![Tests](https://img.shields.io/badge/tests-5578%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.282` / `0.37.9.122` (2026-07-26) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (159 suites / 5578 tests / 0 fail; must ALL pass before push)
