...
[![Tests](https://img.shields.io/badge/tests-4042%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.112` / `0.37.9.68` (2026-06-05) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
