...
[![Tests](https://img.shields.io/badge/tests-5203%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.237` / `0.37.9.97` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (147 suites / 5203 tests / 0 fail; must ALL pass before push)
