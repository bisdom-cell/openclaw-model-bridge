...
[![Tests](https://img.shields.io/badge/tests-5698%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.292` / `0.37.9.129` (2026-08-10) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (164 suites / 5698 tests / 0 fail; must ALL pass before push)
