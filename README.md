...
[![Tests](https://img.shields.io/badge/tests-6608%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.360` / `0.37.9.179` (2026-09-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (200 suites / 6608 tests / 0 fail; must ALL pass before push)
