...
[![Tests](https://img.shields.io/badge/tests-6042%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.320` / `0.37.9.150` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (180 suites / 6042 tests / 0 fail; must ALL pass before push)
