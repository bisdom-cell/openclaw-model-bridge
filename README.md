...
[![Tests](https://img.shields.io/badge/tests-5487%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.262` / `0.37.9.110` (2026-07-08) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (154 suites / 5487 tests / 0 fail; must ALL pass before push)
