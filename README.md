...
[![Tests](https://img.shields.io/badge/tests-6021%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.318` / `0.37.9.148` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (179 suites / 6021 tests / 0 fail; must ALL pass before push)
