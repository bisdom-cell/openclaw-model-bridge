...
[![Tests](https://img.shields.io/badge/tests-6239%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.330` / `0.37.9.159` (2026-08-25) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (187 suites / 6239 tests / 0 fail; must ALL pass before push)
