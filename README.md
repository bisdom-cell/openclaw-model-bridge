...
[![Tests](https://img.shields.io/badge/tests-6168%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.326` / `0.37.9.156` (2026-08-23) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (186 suites / 6168 tests / 0 fail; must ALL pass before push)
