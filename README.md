...
[![Tests](https://img.shields.io/badge/tests-4973%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.213` / `0.37.9.82` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (139 suites / 4973 tests / 0 fail; must ALL pass before push)
