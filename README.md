...
[![Tests](https://img.shields.io/badge/tests-6575%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.357` / `0.37.9.177` (2026-09-22) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (198 suites / 6575 tests / 0 fail; must ALL pass before push)
