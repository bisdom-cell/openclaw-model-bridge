...
[![Tests](https://img.shields.io/badge/tests-5719%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.293` / `0.37.9.130` (2026-08-10) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (165 suites / 5719 tests / 0 fail; must ALL pass before push)
