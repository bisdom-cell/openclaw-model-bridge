...
[![Tests](https://img.shields.io/badge/tests-3657%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.96` / `0.37.9.68` (2026-06-01) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
