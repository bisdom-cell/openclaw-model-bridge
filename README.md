...
[![Tests](https://img.shields.io/badge/tests-5010%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.220` / `0.37.9.85` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (140 suites / 5010 tests / 0 fail; must ALL pass before push)
