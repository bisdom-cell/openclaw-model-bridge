...
[![Tests](https://img.shields.io/badge/tests-5040%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.223` / `0.37.9.88` (2026-07-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (140 suites / 5040 tests / 0 fail; must ALL pass before push)
