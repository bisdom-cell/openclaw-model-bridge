...
[![Tests](https://img.shields.io/badge/tests-4472%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.157` / `0.37.9.70` (2026-06-15) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (128 suites / 4472 tests / 0 fail; must ALL pass before push)
