...
[![Tests](https://img.shields.io/badge/tests-5632%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.286` / `0.37.9.123` (2026-08-06) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (162 suites / 5632 tests / 0 fail; must ALL pass before push)
