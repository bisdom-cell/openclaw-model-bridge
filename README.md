...
[![Tests](https://img.shields.io/badge/tests-5448%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.247` / `0.37.9.101` (2026-07-05) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (153 suites / 5448 tests / 0 fail; must ALL pass before push)
