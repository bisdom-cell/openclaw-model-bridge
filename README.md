...
[![Tests](https://img.shields.io/badge/tests-5469%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.258` / `0.37.9.108` (2026-07-07) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (154 suites / 5469 tests / 0 fail; must ALL pass before push)
