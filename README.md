...
[![Tests](https://img.shields.io/badge/tests-4405%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.146` / `0.37.9.70` (2026-06-13) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (125 suites / 4405 tests / 0 fail; must ALL pass before push)
