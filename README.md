...
[![Tests](https://img.shields.io/badge/tests-5189%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.236` / `0.37.9.96` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (146 suites / 5189 tests / 0 fail; must ALL pass before push)
