...
[![Tests](https://img.shields.io/badge/tests-5240%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.239` / `0.37.9.99` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (149 suites / 5240 tests / 0 fail; must ALL pass before push)
