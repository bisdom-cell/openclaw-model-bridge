...
[![Tests](https://img.shields.io/badge/tests-4791%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.194` / `0.37.9.71` (2026-06-29) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (136 suites / 4791 tests / 0 fail; must ALL pass before push)
