...
[![Tests](https://img.shields.io/badge/tests-6375%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.337` / `0.37.9.163` (2026-09-01) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (192 suites / 6375 tests / 0 fail; must ALL pass before push)
