...
[![Tests](https://img.shields.io/badge/tests-5170%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.234` / `0.37.9.95` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (146 suites / 5170 tests / 0 fail; must ALL pass before push)
