...
[![Tests](https://img.shields.io/badge/tests-6484%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.349` / `0.37.9.175` (2026-09-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (196 suites / 6484 tests / 0 fail; must ALL pass before push)
