...
[![Tests](https://img.shields.io/badge/tests-6330%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.335` / `0.37.9.162` (2026-08-30) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (190 suites / 6330 tests / 0 fail; must ALL pass before push)
