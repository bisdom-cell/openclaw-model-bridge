...
[![Tests](https://img.shields.io/badge/tests-5154%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.232` / `0.37.9.95` (2026-07-03) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (146 suites / 5154 tests / 0 fail; must ALL pass before push)
