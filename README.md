...
[![Tests](https://img.shields.io/badge/tests-6024%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.319` / `0.37.9.149` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (179 suites / 6024 tests / 0 fail; must ALL pass before push)
