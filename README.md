...
[![Tests](https://img.shields.io/badge/tests-5887%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.307` / `0.37.9.139` (2026-08-14) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (173 suites / 5887 tests / 0 fail; must ALL pass before push)
