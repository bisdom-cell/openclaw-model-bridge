...
[![Tests](https://img.shields.io/badge/tests-6413%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.345` / `0.37.9.169` (2026-09-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (194 suites / 6413 tests / 0 fail; must ALL pass before push)
