...
[![Tests](https://img.shields.io/badge/tests-4457%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.156` / `0.37.9.70` (2026-06-15) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (126 suites / 4457 tests / 0 fail; must ALL pass before push)
