...
[![Tests](https://img.shields.io/badge/tests-6571%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.356` / `0.37.9.177` (2026-09-22) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (198 suites / 6571 tests / 0 fail; must ALL pass before push)
