...
[![Tests](https://img.shields.io/badge/tests-3751%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.98` / `0.37.9.68` (2026-06-02) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
