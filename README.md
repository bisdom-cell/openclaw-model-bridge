...
[![Tests](https://img.shields.io/badge/tests-5929%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.309` / `0.37.9.141` (2026-08-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (175 suites / 5929 tests / 0 fail; must ALL pass before push)
