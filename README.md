...
[![Tests](https://img.shields.io/badge/tests-4830%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.195` / `0.37.9.71` (2026-06-29) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (137 suites / 4830 tests / 0 fail; must ALL pass before push)
