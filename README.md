...
[![Tests](https://img.shields.io/badge/tests-5763%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.298` / `0.37.9.132` (2026-08-12) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (167 suites / 5763 tests / 0 fail; must ALL pass before push)
