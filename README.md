...
[![Tests](https://img.shields.io/badge/tests-5984%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.314` / `0.37.9.144` (2026-08-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (178 suites / 5984 tests / 0 fail; must ALL pass before push)
