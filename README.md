...
[![Tests](https://img.shields.io/badge/tests-4375%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.145` / `0.37.9.70` (2026-06-12) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (125 suites / 4375 tests / 0 fail; must ALL pass before push)
