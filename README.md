...
[![Tests](https://img.shields.io/badge/tests-6128%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.324` / `0.37.9.154` (2026-08-21) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (183 suites / 6128 tests / 0 fail; must ALL pass before push)
