...
[![Tests](https://img.shields.io/badge/tests-6048%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.321` / `0.37.9.151` (2026-08-18) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (180 suites / 6048 tests / 0 fail; must ALL pass before push)
