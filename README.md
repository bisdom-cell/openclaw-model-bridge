...
[![Tests](https://img.shields.io/badge/tests-4622%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.164` / `0.37.9.70` (2026-06-17) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (131 suites / 4622 tests / 0 fail; must ALL pass before push)
