...
[![Tests](https://img.shields.io/badge/tests-5535%20passed-brightgreen.svg)]()
...
> **Current version:** `v37.9.274` / `0.37.9.116` (2026-07-24) — see [`CLAUDE.md`](CLAUDE.md) for full changelog.
...
```bash
# Full regression (158 suites / 5535 tests / 0 fail; must ALL pass before push)
