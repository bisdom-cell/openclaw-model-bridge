...
> v37.9.200 (2026-06-30) | **4936 tests** / 138 suites / 0 fail | **8 providers** (含 Doubao Seed 2.0 Pro) | **40 active jobs** | 5 SLO metrics | 19 preflight checks | WhatsApp + Discord dual-channel | **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 95/100 | 27 blood-lesson case docs
...
| **测试** | 138 套单测 | 4936 用例全部通过 | `test_*.py` |
