...
> v37.9.177 (2026-06-18) | **4711 tests** / 134 suites / 0 fail | **8 providers** (含 Doubao Seed 2.0 Pro) | **40 active jobs** | 5 SLO metrics | 19 preflight checks | WhatsApp + Discord dual-channel | **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 95/100 | 26 blood-lesson case docs
...
| **测试** | 134 套单测 | 4711 用例全部通过 | `test_*.py` |
