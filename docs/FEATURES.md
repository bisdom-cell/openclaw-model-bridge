...
> V32 (2026-04-02) | 424 tests | 28 active jobs | 5 SLO metrics | 19 preflight checks
...
| **LLM Provider** | Qwen3-235B (主力) | 文本对话，262K context | `adapter.py` PROVIDERS |
...
| **监控运维** | Job Watchdog | 8 维元监控(job/日志/服务/锁/心跳/stats/磁盘/KB) → WhatsApp 告警 | `job_watchdog.sh` |
