...
> v37.9.354 (2026-09-22) | **6524 tests** / 196 suites / 0 fail | **13 providers** (primary doubao_21) | **41 active jobs** | 5 SLO metrics | preflight full checks | notify 推送（默认 Discord）| **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 98/100 | 28 blood-lesson case docs
...
| **测试** | 196 套单测 | 6524 用例全部通过 | `test_*.py` |
