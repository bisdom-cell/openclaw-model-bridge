...
> v37.9.147 (2026-06-13) | **4428 tests** / 125 suites / 0 fail | **8 providers** (含 Doubao Seed 2.0 Pro) | **40 active jobs** | 5 SLO metrics | 19 preflight checks | WhatsApp + Discord dual-channel | **90 governance invariants / 23 meta-rules / 828 checks / 14 MRD scanners** | security 95/100 | 25 blood-lesson case docs
...
| **测试** | 125 套单测 | 4428 用例全部通过 | `test_*.py` |
