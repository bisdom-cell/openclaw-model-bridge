...
> v37.9.323 (2026-08-20) | **6109 tests** / 182 suites / 0 fail | **12 providers** (primary doubao_21) | **40 active jobs** | 5 SLO metrics | preflight full checks | notify 推送（默认 Discord）| **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 98/100 | 28 blood-lesson case docs
...
| **测试** | 182 套单测 | 6109 用例全部通过 | `test_*.py` |
