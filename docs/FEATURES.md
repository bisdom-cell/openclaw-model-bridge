...
> v37.9.336 (2026-09-01) | **6349 tests** / 191 suites / 0 fail | **12 providers** (primary doubao_21) | **41 active jobs** | 5 SLO metrics | preflight full checks | notify 推送（默认 Discord）| **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 98/100 | 28 blood-lesson case docs
...
| **测试** | 191 套单测 | 6349 用例全部通过 | `test_*.py` |
