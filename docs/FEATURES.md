...
> v37.9.213 (2026-07-02) | **4973 tests** / 139 suites / 0 fail | **10 providers** (含 Doubao Seed 2.0 Pro) | **40 active jobs** | 5 SLO metrics | 19 preflight checks | WhatsApp + Discord dual-channel | **91 governance invariants / 23 meta-rules / 839 checks / 14 MRD scanners** | security 95/100 | 27 blood-lesson case docs
...
| **测试** | 139 套单测 | 4973 用例全部通过 | `test_*.py` |
