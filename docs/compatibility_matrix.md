...
| GLM-5.2 Coding (Volcengine Ark) | glm-5-2-260617 | text | Yes | Yes | 131K | none |
...
| GLM-5.2 Coding (Volcengine Ark) | **declared** | 能力声明完整 + 合约校验通过，0/N 生产验证（无 API key 配置） |
...
| GLM-5.2 Coding (Volcengine Ark) | Yes | — | — | — | Yes | Yes | Yes | — | 131K |
