...
| Doubao Seed 2.1 Pro (ai-tokenhub) | doubao-seed-2-1-pro-260628 | text, vision | Yes | Yes | 262K | tool_calling, reasoning |
...
| Doubao Seed 2.1 Pro (ai-tokenhub) | **feature_verified**（2026-09-02 槽位更正 doubao-2.1 @ ai-tokenhub (V37.9.341) 后 E2E 半升档 (tool_calling+reasoning, V37.9.342)） | ai-tokenhub E2E 探针 2026-09-02 (V37.9.342, model=doubao-seed-2-1-pro-260628): tool_calling+reasoning 2/2 通过 (finish_reason=tool_calls + tool_calls 长度 1 + reasoning 字段填充, usage 466/94, 响应 model 回显本 model id = ai-tokenhub 路由正确)；🔴 verified_text 刻意保持 False —— 该轮带 tools 故 content 为空, 够不着本项目 verified_text 的证据标准 (有 content + finish_reason=stop), 待纯文本探针补齐；vision/streaming/json_mode 本平台未测; Ark 侧 doubao_21 的 5/5 证据不跨平台迁移 |
