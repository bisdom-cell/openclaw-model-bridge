...
| kb_dream | 每天03:00 | `~/kb_dream.sh` | `~/kb_dream.log` | ✅ V32新增→V36.2修复→V37.2调度优化：Agent Dream v2 MapReduce 全量 KB 探索（14源+232笔记逐一提取信号→跨域关联，03:00启动，00:00-06:00 Qwen3算力专属窗口，60分钟全局超时，输出 ~/.kb/dreams/） |
