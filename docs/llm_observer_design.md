...
> 状态：**Stage 0-6 已建成 · `OBSERVER_FP_MODE=on` 生产运行（2026-07-25 起）· A2 精度窗已关（V37.9.296）· 论文 #2 投稿包完成（V37.9.333）**——进度见 §9；本文档最初（2026-06-28）是 Stage 0 design doc，设计原文保留
