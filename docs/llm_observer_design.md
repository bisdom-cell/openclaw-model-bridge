...
- ② A2 精度窗定义 07-26 → 08-08（14 天）；主表实际覆盖 07-27 → 08-07（**12/14 天**）——07-26 是预注册的部署边界剔除行；**08-08 行缺失**（应由 08-09 06:30 run 写入；连同 08-09 行与 `daily_critique_20260808+` 报告一并缺失 = daily_observer 08-09/08-10 两晨疑似未跑，运维核查项已登记 status.json）。数据缺口如实报告，按 §9.2.5 纪律不补造、不事后放宽窗口。
