...
├── run_demo.py                    # exercises 4 config-injected capabilities
...
for the 60-second guide, check-type reference, and the known convergence-path
caveat (scheduled for chunk 3).
