...
|------|------------------------|--------------|
| 1 | **Provider registry + capability routing** | 13 providers (7 built-in + 6 auto-discovered plugins), capability-sorted fallback chain, `find_best_provider(text, prefer reasoning)` → `doubao_21` |
