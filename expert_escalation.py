...
- Reasoning model: expert 后端 = 该槽位当前模型 (V37.9.341 起 doubao-seed-2-1-pro-260628 via ai-tokenhub;
...
# V37.9.341 更正: 该 key 的 /v1/models scope 实为 doubao-seed-2-1-pro-260628 (不含
