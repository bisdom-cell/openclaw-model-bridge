...
print(sc.format_credibility_block())
" 2>/dev/null || echo "")
...
bash "$HOME/movespeed_rsync_helper.sh" "$0" -- -a "$KB_BASE/dreams/" "/Volumes/MOVESPEED/KB/dreams/"  # V37.9.27 jitter+retry+fail-loud+capture (replaces V37.9.4/V37.9.14 inline pattern)
log "完成。模式=$MODE_DESC"
